...
2. **Memory Matching (Flashback)**  
   An offline pseudo scene memory is built from normal and anomalous text descriptions. During inference, incoming embeddings are compared against this memory to produce anomaly scores. :contentReference[oaicite:1]{index=1}
